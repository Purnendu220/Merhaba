...
public class HomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public HomeAdapter(Context context, int shownInScreen, boolean showLoader, AdapterCallbacks<Object> adapterCallbacks) {
    ...
    public void addCategoryListModel(CategoryListModel model) {
        list.add(model);
        addLoader();
    }
    ...
    public int getItemViewType(int position) {
        ...
        else if (item instanceof CategoryListModel) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof SongsViewHolder) {
            if (getItem(position) != null)
                ((SongsViewHolder) holder).bind(getItem(position), adapterCallbacks, position);
