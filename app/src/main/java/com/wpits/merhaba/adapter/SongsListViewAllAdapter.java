...
import com.wpits.merhaba.adapter.viewholder.SongVerticalItemViewHolder;
...
public class SongsListViewAllAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SongsListViewAllAdapter(Context context, int shownInScreen, boolean showLoader, AdapterCallbacks<Object> adapterCallbacks) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof SongVerticalItemViewHolder) {
            if (getItem(position) != null)
                ((SongVerticalItemViewHolder) holder).bind(getItem(position), adapterCallbacks, position);
